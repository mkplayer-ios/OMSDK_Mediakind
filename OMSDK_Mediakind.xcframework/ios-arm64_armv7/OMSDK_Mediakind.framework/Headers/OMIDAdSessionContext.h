 ...
 */
@interface OMIDMediakindAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDMediakindPartner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDMediakindPartner *)partner
                               ...
                               resources:(NSArray<OMIDMediakindVerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
