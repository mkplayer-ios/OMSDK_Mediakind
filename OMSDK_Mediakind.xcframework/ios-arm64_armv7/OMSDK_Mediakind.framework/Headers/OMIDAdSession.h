 ...
 */
@interface OMIDMediakindAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly) OMIDMediakindAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDMediakindAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDMediakindAdSessionContext *)context
