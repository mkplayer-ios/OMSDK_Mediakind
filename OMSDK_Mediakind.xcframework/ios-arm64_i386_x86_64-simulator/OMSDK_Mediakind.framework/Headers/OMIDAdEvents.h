 ...
 */
@interface OMIDMediakindAdEvents : NSObject
 ...
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDMediakindAdSession *)session error:(NSError * _Nullable * _Nullable)error;
 ...
 */
- (BOOL)loadedWithVastProperties:(OMIDMediakindVASTProperties *_Nonnull)vastProperties
