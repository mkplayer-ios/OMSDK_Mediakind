 ...
 */
@interface OMIDNbaAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly) OMIDNbaAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDNbaAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDNbaAdSessionContext *)context
