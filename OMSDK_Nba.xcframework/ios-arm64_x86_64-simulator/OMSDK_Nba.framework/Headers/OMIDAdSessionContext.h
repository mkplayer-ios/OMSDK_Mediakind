 ...
 */
@interface OMIDNbaAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDNbaPartner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDNbaPartner *)partner
                               ...
                               resources:(NSArray<OMIDNbaVerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
