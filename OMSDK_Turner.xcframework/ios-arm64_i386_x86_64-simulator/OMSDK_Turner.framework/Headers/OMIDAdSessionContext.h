 ...
 */
@interface OMIDTurnerAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDTurnerPartner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDTurnerPartner *)partner
                               ...
                               resources:(NSArray<OMIDTurnerVerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
