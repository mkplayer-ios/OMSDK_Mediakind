 ...
 */
@interface OMIDTurnerAdEvents : NSObject
 ...
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDTurnerAdSession *)session error:(NSError * _Nullable * _Nullable)error;
 ...
 */
- (BOOL)loadedWithVastProperties:(OMIDTurnerVASTProperties *_Nonnull)vastProperties
