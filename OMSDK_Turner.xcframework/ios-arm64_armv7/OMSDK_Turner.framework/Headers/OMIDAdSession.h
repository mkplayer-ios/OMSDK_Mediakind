 ...
 */
@interface OMIDTurnerAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly) OMIDTurnerAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDTurnerAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDTurnerAdSessionContext *)context
